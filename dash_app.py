...
# # Define the callback function to update the map based on the selected country code
# @app.callback(Output("map-graph", "figure"), Input("country-dropdown", "value"))
# def update_map(country_code):
#     filtered_data = (
#         data if country_code is None else data[data["country_code"] == country_code]
#     )
#     fig = px.scatter_mapbox(
#         filtered_data,
#         lat="lat",
